...
string face1_path = "1.pgm";//1
string face2_path = "2.pgm";//2
string face3_path = "3.pgm";//3
string face4_path = "4.pgm";//我->4号
...
void detectAndDisplay(Mat frame)
{
	...
	for (size_t i = 0; i < faces.size(); i++)
	{
		...
		if (predictPCA == 4)
		{
			putText(frame, "Hello xiaoCai", Point(faces[i].x, faces[i].y), FONT_HERSHEY_SIMPLEX, 1.5, Scalar(0, 0, 255), 2);
