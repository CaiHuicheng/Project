...
void match_features(Mat& query, Mat& train, vector<DMatch>& matches)
{
	...
	for (size_t r = 0; r < knn_matches.size(); ++r)
	{
		...
		//cout << "matches:" << knn_matches[r][0].distance << endl;
	}
}
...
void main()
{
	...
	get_file_names("images03", img_names);
	//string file = "PictureData.txt";
	//imageFile(file, img_names);

	//内参数
	/*images00 : 520.9, 0, 325.1, 0, 521.0, 249.7, 0, 0, 1*/
	/*images01 : 2759.48, 0, 1520.69,0, 2764.16, 1006.81,0, 0, 1*/
	/*images02 : 874.85, 0, 637.32, 0,874.85, 372.90, 0, 0, 1 */
	Mat K(Matx33d(874.85, 0, 637.32, 0, 874.85, 372.90, 0, 0, 1));
	...
	ShellExecute(NULL, "open", ".\\Viewer\\SfMViewer.exe", NULL, ".\\Viewer", SW_SHOW);
	system("pause");
}