...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lb601 = QtWidgets.QLabel(self.lbFrame)
        self.lb601.setMinimumSize(QtCore.QSize(100, 23))
        self.lb601.setMaximumSize(QtCore.QSize(100, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lb601.setFont(font)
        self.lb601.setAlignment(QtCore.Qt.AlignCenter)
        self.lb601.setObjectName("lb601")
        self.horizontalLayout_3.addWidget(self.lb601)
        self.lbDorm = QtWidgets.QLabel(self.lbFrame)
        self.lbDorm.setMinimumSize(QtCore.QSize(0, 23))
        self.lbDorm.setMaximumSize(QtCore.QSize(16777215, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lbDorm.setFont(font)
        self.lbDorm.setAlignment(QtCore.Qt.AlignCenter)
        self.lbDorm.setObjectName("lbDorm")
        self.horizontalLayout_3.addWidget(self.lbDorm)
        ...
        self.lbShowImg.setMinimumSize(QtCore.QSize(228, 0))
        self.lbShowImg.setMaximumSize(QtCore.QSize(228, 11111))
        ...
        # 调用更新显示更新显示信息调用
        self.updateShowInfo("1", "李四", "滨海学院", "软件工程", "601", "36.5", "正常")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "身份证识别信息"))
        ...
        self.lb601.setText(_translate("Form", "宿舍："))
        self.lbDorm.setText(_translate("Form", "TextLabel"))
    ...
    def showVideo(self):
        ...
        #
        # self.lbShowImg.setPixmap(QPixmap.fromImage(showImage))
        # # self.lbShowImg.setScaledContents(False)
