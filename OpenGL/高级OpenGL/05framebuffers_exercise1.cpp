...
int main()
{
    ...
    // -------------------------
	Shader shader("./高级OpenGL/shaders/5-2framebuffers.vs", "./高级OpenGL/shaders/5-2framebuffers.fs");
	Shader screenShader("./高级OpenGL/shaders/5-2framebuffers_screen.vs", "./高级OpenGL/shaders/5-2framebuffers_screen.fs");
