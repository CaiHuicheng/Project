...
int main()
{
    ...
    // -------------------------
    Shader shader("./高级光照/shaders/5.2.parallax_mapping.vs", "./高级光照/shaders/5.2.parallax_mapping.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("./高级光照/images/bricks2.jpg");
    unsigned int normalMap = loadTexture("./高级光照/images/bricks2_normal.jpg");
    unsigned int heightMap = loadTexture("./高级光照/images/bricks2_disp.jpg");
